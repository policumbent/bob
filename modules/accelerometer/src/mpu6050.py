"""
Fork of https://github.com/m-rtijn/mpu6050, used for a team Policumbent project

Copyright (c) 2022 gabelluardo (gabriele.belluardo@outlook.it) 
...
class mpu6050:
    ...
    def set_filter_range(self, filter_range=FILTER_BW_256):
        ...
        EXT_SYNC_SET = (
            self.bus.read_byte_data(self.address, self.MPU_CONFIG) & 0b00111000
        )
        return self.bus.write_byte_data(
            self.address, self.MPU_CONFIG, EXT_SYNC_SET | filter_range
        )
