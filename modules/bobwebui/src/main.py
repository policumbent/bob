...
def main():
    ...
    parser.add_argument('-l', '--listen', metavar='value', default=host,
                        help='listen address (host or ip), default: 127.0.0.1')
    parser.add_argument('-p', '--port', metavar='value', default=port, help='listen port, default: 10080')
    parser.add_argument('-v', '--verbose', action='count', default=0,
                        help='be verbose (add more v to increase verbosity)')
